...
#Розроботка Приложений на Backbone.js
...
Это домашняя страница перевода книги 'Developing Backbone.js Applications' ("Розроботка Приложений на Backbone.js"). Это книга об фреймворке Backbone.js для структурированых JavaScript приложений. Книга роспростаняется на правах [CC](http://creativecommons.org/licenses/by-nc-sa/3.0/)-лицензии. 
...
Я очень надеюсь что эту книгу также получится выпустить и в печатном издании через несколько месяцев через [O'Reilly Media](http://oreilly.com). Читатель будет иметь возможность купить последнюю версмю в печатном или розличных електронных форматах или сможет взять безплатную копию с этого репозитория.
